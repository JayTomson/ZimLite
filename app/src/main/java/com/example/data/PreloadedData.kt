            ...
            ArticleEntity(
                ...
                htmlContent = """
                    <div class="article-container">
                        ...
                        <p><strong>Kotlin</strong> — кроссплатформенный статически типизированный язык программирования общего назначения. Разработан компанией JetBrains. Он широко используется для систем на основе <a href="wiki/AI.html">искусственного интеллекта</a> и является основным языком в составе <a href="wiki/Kiwix.html">Kiwix</a> для создания современных Android-интерфейсов.</p>
            ...
            ArticleEntity(
                ...
                htmlContent = """
                    <div class="article-container">
                        ...
                        <p><strong>Kiwix</strong> — свободная программа для чтения веб-контента в автономном (офлайн) режиме. Программа в первую очередь предназначена для доступа к <a href="wiki/Wikipedia.html">Википедии</a> без подключения к Интернету, однако поддерживает любые веб-проекты, упакованные в формат <strong>ZIM</strong>.</p>
